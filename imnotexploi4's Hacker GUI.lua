...
local uwu = Instance.new("TextButton")
local grab = Instance.new("TextButton")
local devuzi = Instance.new("TextButton")
local ImageLabel_2 = Instance.new("ImageLabel")
-- Pro...:
weebgui.Name = "weebgui"
weebgui.Parent = game.CoreGui
weebgui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
weebgui.ResetOnSpawn = false

Frame.Parent = weebgui
Frame.Active = true
Frame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Frame.BorderColor3 = Color3.fromRGB(255, 255, 255)
Frame.BorderSizePixel = 3
Frame.Position = UDim2.new(0.483179331, 0, 0.300017834, 0)
...
TextLabel.Text = "imnotexploi4 Hacker GUI"
...
particle.BorderColor3 = Color3.fromRGB(255, 255, 255)
...
particle.Text = "particle emitter"
...
ImageLabel.Position = UDim2.new(0.935456038, 0, 0.0800492242, 0)
ImageLabel.Size = UDim2.new(0, 60, 0, 49)
ImageLabel.ZIndex = 69
ImageLabel.Image = "rbxassetid://128178445034767"
...
TextLabel_2.Text = "totally not skid - by imnotexploi4.discord: the_baconthecheat"
...
uwu.Name = "uwu"
uwu.Parent = Frame
uwu.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
uwu.BorderColor3 = Color3.fromRGB(255, 255, 255)
uwu.BorderSizePixel = 3
uwu.Position = UDim2.new(0, 0, 0.470198661, 0)
uwu.Size = UDim2.new(0, 155, 0, 43)
uwu.Font = Enum.Font.SourceSans
uwu.Text = "imnotexploi4 Laugh"
uwu.TextColor3 = Color3.fromRGB(255, 255, 255)
uwu.TextScaled = true
uwu.TextSize = 14.000
uwu.TextWrapped = true

grab.Name = "grab"
grab.Parent = Frame
grab.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
grab.BorderColor3 = Color3.fromRGB(255, 255, 255)
...
devuzi.BorderColor3 = Color3.fromRGB(255, 255, 255)
...
ImageLabel_2.Position = UDim2.new(0.497129261, 0, 0.816711426, 0)
ImageLabel_2.Size = UDim2.new(0, 155, 0, 110)
ImageLabel_2.ZIndex = 0
ImageLabel_2.Image = "rbxassetid://129782687650731"

-- Scripts:

local function XPTC_fake_script() -- skybox.sky 
	local script = Instance.new('Script', skybox)

	script.Parent.MouseButton1Click:Connect(function()
		local sky = Instance.new("Sky", game.Lighting)
		sky.SkyboxBk = "rbxassetid://129782687650731"
		sky.SkyboxDn = "rbxassetid://129782687650731"
		sky.SkyboxFt = "rbxassetid://129782687650731"
		sky.SkyboxLf = "rbxassetid://129782687650731"
		sky.SkyboxRt = "rbxassetid://129782687650731"
		sky.SkyboxUp = "rbxassetid://129782687650731"
	end)
end
coroutine.wrap(XPTC_fake_script)()
local function LKQF_fake_script() -- music.mus 
	local script = Instance.new('Script', music)

	script.Parent.MouseButton1Click:Connect(function()
		local music = Instance.new("Sound", game.Workspace)
		music.Name = "imnotexploi4MusicHacker"
		music.SoundId = "rbxassetid://15689451063"
		music.Volume = 3
		music.Looped = true
		music:Play()
	end)
end
coroutine.wrap(LKQF_fake_script)()
local function QWYHY_fake_script() -- particle.part 
...
local function XSZAA_fake_script() -- disco.discoo 
...
coroutine.wrap(XSZAA_fake_script)()
local function JPTMGZ_fake_script() -- Frame.drag 
	local script = Instance.new('LocalScript', Frame)

	script.Parent.Draggable = true
end
coroutine.wrap(JPTMGZ_fake_script)()
local function XQOLIA_fake_script() -- message.mess 
...
local function SCNKCSN_fake_script() -- decal.sky 
	local script = Instance.new('Script', decal)

	script.Parent.MouseButton1Click:Connect(function()
		function exPro(root)
			for _, v in pairs(root:GetChildren()) do
				if v:IsA("Decal") and v.Texture ~= "https://www.roblox.com/asset/?id=129782687650731" then
					v.Parent = nil
				elseif v:IsA("BasePart") then
					...
					One.Texture = "https://www.roblox.com/asset/?id=129782687650731"
					Two.Texture = "https://www.roblox.com/asset/?id=129782687650731"
					Three.Texture = "https://www.roblox.com/asset/?id=129782687650731"
					Four.Texture = "https://www.roblox.com/asset/?id=129782687650731"
					Five.Texture = "https://www.roblox.com/asset/?id=129782687650731"
					Six.Texture = "https://www.roblox.com/asset/?id=129782687650731"
					One.Face = "Front"
					Two.Face = "Back"
					Three.Face = "Right"
					Four.Face = "Left"
...
coroutine.wrap(SCNKCSN_fake_script)()
local function KCSYXP_fake_script() -- uwu.Script 
	local script = Instance.new('Script', uwu)

	script.Parent.MouseButton1Click:Connect(function()
		local music = Instance.new("Sound", game.Workspace)
		music.Name = "imnotexploi4Laugh"
		music.SoundId = "rbxassetid://319332735"
		music.Volume = 5
		music:Play()
	end)
end
coroutine.wrap(KCSYXP_fake_script)()
local function TKZN_fake_script() -- grab.LocalScript 
...
coroutine.wrap(TKZN_fake_script)()
local function USNJ_fake_script() -- devuzi.dev 
...
coroutine.wrap(USNJ_fake_script)()
